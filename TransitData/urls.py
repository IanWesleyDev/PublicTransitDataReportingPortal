...
urlpatterns = [
    ...
    path('summary/admin/wsdot_review_cover_sheet/add_note/<int:year>/<summary_report_status_id>/<note_area>', views.add_cover_sheet_note_wsdot, name="add_cover_sheet_note_wsdot"),
