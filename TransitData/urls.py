...
urlpatterns = [
    ...
    path('summary/report_data/report_transit_data/<int:year>', views.report_transit_data, name='report_transit_data_year'),
    path('summary/report_data/report_transit_data/<int:year>/<service>', views.report_transit_data, name='report_transit_data_year_mode'),
    path('summary/report_data/report_revenue', views.report_revenue, name='report_revenue'),
    path('summary/report_data/report_revenue/<int:year>', views.report_revenue, name='report_revenue_year'),
    path('summary/report_data/report_revenue/<int:year>/<funding_type>/<government_type>', views.report_revenue, name='report_revenue_year_type'),
    path('summary/report_data/report_expenses/', views.report_expenses, name='report_expenses'),
    path('summary/report_data/report_expenses/<int:year>', views.report_expenses, name='report_expenses_year'),
