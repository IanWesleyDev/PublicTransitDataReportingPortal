# Generated by Django 2.2.6 on 2020-02-10 18:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='statewide_measures',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, max_length=200, null=True)),
                ('transit_data_files', models.CharField(blank=True, max_length=500, null=True)),
                ('data_type', models.CharField(blank=True, max_length=40, null=True)),
                ('measure_type', models.CharField(blank=True, max_length=40, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='stylesheets',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rollup_mode', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='Panacea.rollup_mode')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('administration_of_mode', models.CharField(choices=[('Direct Operated', 'Direct Operated'), ('Purchased', 'Purchased')], max_length=80)),
                ('organization', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='Panacea.organization')),
                ('transit_mode', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='Panacea.transit_mode')),
            ],
        ),
        migrations.CreateModel(
            name='revenue_source',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published_version', models.BooleanField(blank=True, default=True, null=True)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('organization', 'year', 'fund_balance_type'), name='unique_end_balance'),
        ),
        migrations.AddConstraint(
            model_name='expense',
            constraint=models.UniqueConstraint(fields=('organization', 'year', 'expense_source'), name='unique_source_report'),
        ),
        migrations.AddConstraint(
